<nav class="navbar navbar-expand-lg navbar-light bg-light ">
    <a class="navbar-brand" href="#">
        <img src="{{ asset('img/logo.jpeg') }}" width="30" height="30" class="d-inline-block align-top" alt="">
        آکادمی
    </a>
            ...
            <ul class="navbar-nav">
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu logout-btn" aria-labelledby="navbarDropdown">
                        <a href="{{ route('auth.two.factor.toggle.form', ['id'=>1]) }}" class="dropdown-item">@lang('auth.two factor authentication')</a>
